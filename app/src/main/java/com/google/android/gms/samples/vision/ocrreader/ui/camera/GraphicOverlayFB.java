...
/**
 * Created by mgo983 on 8/28/18.
 */

public class GraphicOverlayFB <T extends GraphicOverlayFB.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link GraphicOverlay#add(GraphicOverlay.Graphic)}.
     */
    public static abstract class Graphic {
        private GraphicOverlayFB mOverlay;

        public Graphic(GraphicOverlayFB overlay) {
            mOverlay = overlay;
        }
